    ...
    <footer className="bg-secondary text-secondary-foreground border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-8">
          <div className="col-span-1 md:col-span-4 lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-secondary-foreground/70">
              Your trusted partner in innovative and reliable financing
              solutions for real estate and business ambitions.
            </p>
          </div>

          {footerLinks.map((section) => (
            <div key={section.title}>
              <h3 className="font-semibold text-secondary-foreground/90">
                {section.title}
              </h3>
          ...
          <div className="md:col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-2 mt-4">
              <Input
                ...
                className="bg-background/20 border-border/50 placeholder:text-secondary-foreground/50"
              />
        ...
        <div className="mt-12 pt-8 border-t border-border/20 text-center text-sm text-secondary-foreground/60">
          <p>
            &copy; {new Date().getFullYear()} Lankford Capital. All Rights
            Reserved.
          </p>
        </div>
      </div>
